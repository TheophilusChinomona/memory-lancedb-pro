...
export class SmartExtractor {
    ...
    async extractAndPersist(conversationText, sessionKey = "unknown", options = {}) {
        ...
        for (const { index, candidate } of processableCandidates) {
            try {
                await this.processCandidate(candidate, conversationText, sessionKey, stats, targetScope, scopeFilter, precomputedVectors.get(index));
            }
            catch (err) {
     ...
     */
    async processCandidate(candidate, conversationText, sessionKey, stats, targetScope, scopeFilter, precomputedVector) {
